...
from airtest.error import *  # noqa
from airtest.utils import generate_result, check_image_valid, print_run_time
from airtest.cal_confidence import cal_ccoeff_confidence, cal_rgb_confidence
