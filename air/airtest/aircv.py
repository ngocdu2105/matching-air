...
import cv2
import numpy as np
from airtest.error import FileNotExistError
from six import PY2, PY3
from airtest.utils import cv2_2_pil, compress_image
...
def mark_point(img, point, circle=False, color=100, radius=10):
    """ 调试用的: 标记一个点 """
    x, y = point
    x,y = int(x),int(y)
